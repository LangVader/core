...
### 👶 **Para Niños (`ejemplos/para_ninos/`)**
...
### 2️⃣ **Ejecuta tu primer programa**
```bash
...
### 🚀 [Descargar Vader](https://github.com/tu-usuario/vader) | 📚 [Documentación](https://docs.vader-lang.org) | 💬 [Comunidad](https://discord.gg/vader)
