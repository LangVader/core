...
# Configuración del proveedor de IA: openai
AI_PROVIDER = "openai"
...
async def main():
    ...
    try:
        print("🌟 Vader CLI Runtime funcionando perfectamente")
        print("✅ Variables, funciones y condicionales OK")
        print("Hola desde  + nombre")
        print("🎉 Función ejecutada correctamente")
        print("🏆 Runtime CLI completamente funcional")
